...
{
	a += 20.0; // this is for Plane position takeoff on x axis
...
void display(void)
{
	glClearColor(0.7, 0.96, 0.95, 0.0);
...
void display2()
{
	glClearColor(0.92, 0.67, 0.4, 0.0);
	glClear(GL_COLOR_BUFFER_BIT);
	glPushMatrix();
	glTranslated(d, 300.0, 0.0);
	glColor3f(1.0, 1.0, 1.0);
	glBegin(GL_POLYGON);//aroplane body(rectangle)
	glVertex2f(0.0, 30.0);
	glVertex2f(0.0, 55.0);
	glVertex2f(135.0, 55.0);
	glVertex2f(135.0, 30.0);
...
void display3()
{
	glClearColor(0.1, 0.04, 0.38, 0.0);
	glClear(GL_COLOR_BUFFER_BIT);
	building();
	glPushMatrix();
	glTranslated(e, 300.0, 0.0);
	glColor3f(1.0, 1.0, 1.0);//aroplane body(rectangle)
	glBegin(GL_POLYGON);
	glVertex2f(0.0, 30.0);
	glVertex2f(0.0, 55.0);
	glVertex2f(135.0, 55.0);
